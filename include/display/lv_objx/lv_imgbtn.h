 ...
 * button
 * @param copy pointer to a image button object, if not NULL then the new object
 ...
 */
void lv_imgbtn_set_src(lv_obj_t *imgbtn, lv_btn_state_t state,
 ...
 */
void lv_imgbtn_set_style(lv_obj_t *imgbtn, lv_imgbtn_style_t type,
                         lv_style_t *style);
