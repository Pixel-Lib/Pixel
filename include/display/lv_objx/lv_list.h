...
/**
 * Make a button selected. Can be used while navigating in the list with a
 * keypad.
 * @param list pointer to a list object
 ...
 * @param btn pointer to a list element (button)
 * @return the index of the button in the list, or -1 of the button not in this
 * list
 */
