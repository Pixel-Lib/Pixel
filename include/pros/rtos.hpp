...
class Task {
    public:
         ...
         * notification value \param prev_value A pointer to store the previous
         * value of the target task's notification, may be NULL
         *
...
template <typename Var> class MutexVar {
    ...
    public:
         ...
         */
        template <typename... Args> MutexVar(Args &&...args) : mutex(), var(std::forward<Args>(args)...) {}
