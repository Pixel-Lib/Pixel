...
class Gps {
    ...
    public:
         ...
         * turning (meters) \param  yOffset Cartesian 4-Quadrant Y offset from
         * center of turning (meters) \param  xInitial Initial 4-Quadrant X
         * Position, with (0,0) being at the center of the field (meters) \param
         * yInitial Initial 4-Quadrant Y Position, with (0,0) being at the center of
         * the field (meters) \param  headingInitial Heading with 0 being north on
         * the field, in degrees [0,360) going clockwise \return 1 if the operation
         * was successful or PROS_ERR if the operation failed, setting errno.
         */
         ...
         * 				 Cartesian 4-Quadrant X offset from center of
         * turning (meters) \param  yOffset Cartesian 4-Quadrant Y offset from
         * center of turning (meters) \return 1 if the operation was successful or
         * PROS_ERR if the operation failed, setting errno.
         */
        virtual std::int32_t set_offset(double xOffset, double yOffset) const;

        /**
         * Get the GPS's location relative to the center of turning/origin in
         * meters.
         *
         * This function uses the following values of errno when an error state is
         * reached:
         ...
         * center of turning (meters) \param  yOffset Pointer to cartesian
         * 4-Quadrant Y offset from center of turning (meters) \return 1 if the
         * operation was successful or PROS_ERR if the operation failed, setting
         * errno.
         */
         ...
         * Position, with (0,0) being at the center of the field (meters) \param
         * headingInitial Heading with 0 being north on the field, in degrees
