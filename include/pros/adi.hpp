...
class ADIEncoder : private ADIPort {
    public:
        ...
        // Delete copy constructor to prevent a compilation error from the
        // constructor above.
...
class ADIUltrasonic : private ADIPort {
    public:
         ...
         *port 1, 3, 5, or 7 ('A', 'C', 'E', 'G'). \param port_echo The port
         *connected to the yellow INPUT cable. This should be in the next highest
         *port following port_ping.
         */
...
class ADIGyro : private ADIPort {
    public:
         ...
         * calibration period.
         *
         * It is highly recommended that an ADIGyro object be created in
         *initialize() when the robot is stationary to ensure proper calibration. If
         *an ADIGyro object is declared at the global scope, a hardcoded 1300ms
...
class ADIPotentiometer : public ADIAnalogIn {
    public:
         ...
         * Potentiometer V2 rotates 330 degrees thus returning an angle between
         0-330 degrees.
         *
         * This function uses the following values of errno when an error state is
         * reached:
