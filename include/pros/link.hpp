...
class Link {
    ...
    public:
         ...
         * the brain is a transmitter or reciever, with the transmitter having
         * double the transmitting bandwidth as the recieving end (1040 bytes/s vs
         * 520 bytes/s). \param ov Indicates if the radio on the given port needs
         ...
         * ENODEV - The port cannot be configured as a radio.
         * ENXIO - The sensor is still calibrating, or no link is connected via the
         * radio. EINVAL - The destination given is NULL, or the size given is
         * larger than the FIFO buffer or destination buffer.
         *
         * \param dest
