 ...
 * links in the area. \param type Indicates whether the radio link on the brain
 * is a transmitter or reciever, with the transmitter having double the
 * transmitting bandwidth as the recieving end (1040 bytes/s vs 520 bytes/s).
 *
