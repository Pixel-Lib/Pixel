...
struct Constraints {
         ...
         *                   meters per second per second.
         */
        Constraints(double imax_vel, double imax_accel = std::numeric_limits<double>::max(),
                    double imax_jerk = std::numeric_limits<double>::max(), double imax_curvature = 1000,
        ...
        std::string to_string() const {
            return "Constraints: {max_vel: " + std::to_string(max_vel) + ", max_accel: " + std::to_string(max_accel)
                   + ", max_jerk: " + std::to_string(max_jerk) + ", min_accel: " + std::to_string(min_accel) + "}";
        }
