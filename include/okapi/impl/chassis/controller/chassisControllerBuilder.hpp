...
class ChassisControllerBuilder {
    public:
         ...
         */
        explicit ChassisControllerBuilder(const std::shared_ptr<Logger> &ilogger = Logger::getDefaultLogger());
         ...
         * @return An ongoing builder.
         */
        ChassisControllerBuilder &withMotors(const Motor &itopLeft, const Motor &itopRight, const Motor &ibottomRight,
         ...
         * @return An ongoing builder.
         */
        ChassisControllerBuilder &withMotors(const MotorGroup &itopLeft, const MotorGroup &itopRight,
