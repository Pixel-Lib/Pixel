...
class IterativeVelPIDController : public IterativeVelocityController<double, double> {
    public:
         ...
         */
        IterativeVelPIDController(double ikP, double ikD, double ikF, double ikSF, std::unique_ptr<VelMath> ivelMath,
         ...
         * @param ilogger The logger this instance will log to.
         */
        IterativeVelPIDController(const Gains &igains, std::unique_ptr<VelMath> ivelMath, const TimeUtil &itimeUtil,
                                  std::unique_ptr<Filter> iderivativeFilter = std::make_unique<PassthroughFilter>(),
                                  std::shared_ptr<Logger> ilogger = Logger::getDefaultLogger());
