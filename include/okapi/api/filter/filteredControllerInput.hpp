 ...
 */
template <typename InputType, typename FilterType> class FilteredControllerInput : public ControllerInput<double> {
    public:
        /**
         ...
         */
        double controllerGet() override { return filter->filter(input->controllerGet()); }
