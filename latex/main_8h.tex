...
If defined, C++ literals will be available for use. All literals are in the \mbox{\hyperlink{namespacepros_1_1literals}{pros\+::literals}} namespace.
...
You should add more \#includes here If you find doing \mbox{\hyperlink{classpros_1_1Motor}{pros\+::\+Motor()}} to be tedious and you\textquotesingle{}d prefer just to do Motor, you can use the namespace with the following commented out line.

IMPORTANT\+: Only the okapi or pros namespace may be used, not both concurrently! The okapi namespace will export all symbols inside the pros namespace. Prototypes for the competition control tasks are redefined here to ensure that they can be called from user code (i.\+e. calling autonomous from a button press in \mbox{\hyperlink{main_8cpp_ac57194c628bb97b849be48d79c99c4ac}{opcontrol()}} for testing purposes).
...
If the robot is disabled or communications is lost, the autonomous task will be stopped. Re-\/enabling the robot will restart the task, not re-\/start it from where it left off. \mbox{\Hypertarget{main_8h_a16a77889800f9a99f69f9dd026013505}\label{main_8h_a16a77889800f9a99f69f9dd026013505}} 
...
Runs while the robot is in the disabled state of Field Management System or the VEX Competition Switch, following either autonomous or opcontrol. When the robot is enabled, this task will exit. \mbox{\Hypertarget{main_8h_a9efe22aaead3a5e936b5df459de02eba}\label{main_8h_a9efe22aaead3a5e936b5df459de02eba}} 
